...
const RENTAL_STEPS = [
  {
    ...
    desc: "Visit our Plans page and pick 3, 6, or 12 months. All plans include free delivery, installation, maintenance, and repairs.",
    detail: "Takes less than 2 minutes. No payment needed upfront.",
  },
  {
    num: "02",
    icon: "📋",
    title: "Fill the Booking Form",
    desc: "Submit your name, address, phone number, and preferred date. Our team reviews it immediately.",
    detail: "Or just WhatsApp us at +91 81790 19929 — even simpler.",
  },
  {
    num: "03",
    icon: "📞",
    title: "Confirmation Call",
    desc: "We call you within 2 hours to confirm your slot, answer questions, and finalize the model you'd like.",
    detail:
      "We'll also suggest the best model based on your water TDS — free of charge.",
  },
  {
    num: "04",
    icon: "🚗",
    title: "We Deliver to You",
    desc: "Our technician arrives at your chosen date and time with the purifier, all tools, and mounting hardware.",
    detail:
      "Delivery and installation are 100% free — no hidden logistics charges.",
  },
  {
    num: "05",
    icon: "🔩",
    title: "Installation & Testing",
    desc: "Purifier is mounted, pipes connected, and water quality tested on-site. We demonstrate how to use it.",
    detail:
      "Typical installation takes 30–60 minutes depending on your kitchen setup.",
  },
  {
    num: "06",
    icon: "💧",
    title: "Start Drinking Pure Water",
    desc: "First payment is made after installation is complete and you're satisfied. Then monthly on the same date.",
    detail:
      "We send digital reminders for payments and scheduled maintenance visits.",
  },
];
...
const SERVICE_STEPS = [
  {
    ...
    desc: "Contact us with your issue — motor not working, low flow, bad taste, error light, or just routine service. We log it immediately.",
  },
  {
    num: "02",
    icon: "⏰",
    title: "Slot Confirmed in 30 Min",
    desc: "We confirm a same-day or next-morning slot based on your preference and technician availability in your area.",
  },
  {
    num: "03",
    icon: "🧰",
    title: "Technician Arrives",
    desc: "Our certified technician arrives with the right tools and common spare parts. They carry OEM parts for all 8 brands.",
  },
  {
    num: "04",
    icon: "🔬",
    title: "Diagnosis & Fix",
    desc: "Technician diagnoses the issue, explains the problem clearly, and completes the repair with your approval on any part changes.",
  },
  {
    num: "05",
    icon: "🧪",
    title: "Water Quality Test",
    desc: "Post-repair, water quality and TDS are tested to confirm everything is working correctly before leaving your home.",
  },
  {
    num: "06",
    icon: "📄",
    title: "Report & Bill via WhatsApp",
    desc: "You receive a digital service report and itemized bill instantly via WhatsApp. For rental customers — zero charge.",
  },
];
...
export default function HowItWorksPage() {
  ...
  return (
    <>
      ...
      >
        <div className="hiw-blob absolute -top-24 -right-24 opacity-20 pointer-events-none">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="hiw-sub text-lg text-blue-200">
            From booking to installation, we make the entire process effortless.
            No paperwork, no hassle, no upfront cost.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-black text-slate-900">
              {activeTab === "rental"
                ? "How to Rent a Purifier"
                : "How to Book a Service"}
            </h2>
            <p className="text-slate-500 mt-2 text-sm">
              {activeTab === "rental"
                ? "From booking to your first glass of pure water — here's every step."
                : "From your call to a fixed purifier — here's what happens."}
            </p>
          </div>
              ...
              {steps.map((step, i) => (
                <div key={i} className={`${stepClass} flex gap-8 items-start`}>
                  <div className="relative flex-shrink-0 hidden md:block">
                    ...
                    <span className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-white border-2 border-[#1e3a8a] text-[#1e3a8a] font-black text-xs flex items-center justify-center">
                      {i + 1}
                    </span>
                  </div>
                  ...
                  <div className="flex-1 bg-white rounded-3xl p-6 border border-slate-100 hover:border-[#1e3a8a]/30 hover:shadow-xl hover:shadow-blue-900/8 transition-all group">
                    <div className="md:hidden flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#1e3a8a] to-blue-500 flex items-center justify-center text-xl">
                        {step.icon}
                      </div>
                    ...
                    <div className="hidden md:block text-xs font-black text-[#1e3a8a] uppercase tracking-widest mb-2">
                      Step {step.num}
                    </div>
                    ...
                    {step.detail && (
                      <div className="flex items-start gap-2 bg-blue-50 rounded-xl px-4 py-2.5">
                        ...
                        <span className="text-[#1e3a8a] text-xs font-medium leading-relaxed">
                          {step.detail}
                        </span>
                      </div>
                    )}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6">
            ...
            {[
              {
                ...
                a: "Same day in most cases. Next morning at latest.",
              },
              {
                q: "Is there any security deposit?",
                a: "No. Zero security deposit required for all plans.",
              },
              {
                q: "What if the purifier breaks down?",
                a: "Call us. We dispatch a technician same day at no cost.",
              },
              {
                q: "Can I change the model after installation?",
                a: "Yes, anytime. Model upgrades are free of charge.",
              },
              {
                q: "Do I need to be home during installation?",
                a: "Yes, an adult must be present. Takes 30–60 minutes.",
              },
              {
                q: "How do I pay monthly?",
                a: "UPI, bank transfer, or cash. Digital receipt via WhatsApp.",
              },
            ].map((qa, i) => (
              <div
                key={i}
                className="bg-[#f1f5f9] rounded-2xl p-5 border border-blue-100 hover:border-[#1e3a8a]/30 transition-all"
              >
          ...
          <div className="text-center mt-8">
            <Link
              href="/faq"
              className="inline-flex items-center gap-2 text-[#1e3a8a] font-bold hover:gap-3 transition-all"
            >
              See all FAQs →
            </Link>
          </div>
      ...
      >
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-blue-200 mb-8">
            The whole process takes less than 5 minutes to kick off. Clean water
            starts today.
          </p>
