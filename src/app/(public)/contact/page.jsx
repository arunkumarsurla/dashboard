      ...
      <section className="py-16 bg-[#f1f5f9]">
        <div className="contact-grid max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-4">
          {[
            ...
            <Link key={i} href={c.href} className={`contact-card group relative bg-gradient-to-br ${c.bg} rounded-2xl p-6 text-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden`}>
          ...
          <div className="contact-form-inner bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-blue-900/5 border border-blue-50">
            {submitted ? (
              <div className="text-center py-12">
                ...
                <Link href="https://wa.me/918179019929?text=Hi!%20I%20just%20sent%20an%20enquiry%20on%20your%20website." className="inline-flex items-center gap-2 bg-green-500 text-white font-bold px-8 py-4 rounded-2xl hover:bg-green-600 transition-colors">💬 Continue on WhatsApp</Link>
              </div>
            ) : (
              <>
                <div className="mb-8">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#f1f5f9] rounded-3xl h-80 flex items-center justify-center border border-blue-100">
            <div className="text-center">
              ...
              <Link href="https://maps.google.com/?q=NAD+Junction+Visakhapatnam" target="_blank" rel="noreferrer" className="inline-block mt-4 bg-[#1e3a8a] text-white text-sm font-bold px-5 py-2.5 rounded-xl hover:bg-blue-800 transition-colors">Open in Google Maps →</Link>
            </div>
          </div>
        </div>
      </section>

      <Link href="https://wa.me/918179019929?text=Hi!%20I%20need%20water%20purifier%20service." target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 text-white rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 hover:bg-green-400 hover:scale-110 transition-all duration-300">
