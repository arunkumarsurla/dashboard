...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Decorative waves */}
      <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 1440 810"
        preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        <path fill="#5b8fc7" fillOpacity=".2"
          d="M0,400 C300,500 600,450 900,400 C1200,350 1350,380 1440,400 L1440,810 L0,810 Z"/>
        <path fill="#4a7bb7" fillOpacity=".35"
          d="M0,460 C350,560 650,510 950,460 C1250,410 1380,440 1440,460 L1440,810 L0,810 Z"/>
        <path fill="#1e5a9e" fillOpacity=".55"
      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md relative z-10 animate-fadeIn">
        <div className="text-center mb-7">
          <div className="inline-flex items-center justify-center "
            ...
            <Image src="/mkl_logo.jpeg" width={100} height={100} alt="logo"/>
            {/* <Droplets size={30} className="text-white"/> */}
          </div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight">MKL Admin</h1>
